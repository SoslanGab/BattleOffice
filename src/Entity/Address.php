...
class Address
{
    ...
    #[ORM\OneToMany(mappedBy: 'address_billing', targetEntity: Order::class)]
    ...
    public function removeOrder(Order $order): static
    {
        if ($this->orders->removeElement($order)) {
            ...
            if ($order->getAddressBilling() === $this) {
                $order->setAddressBilling(null);
            }
        }
